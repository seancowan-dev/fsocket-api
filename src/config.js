module.exports = {
    ...
    ORIGIN_URL: "https://fsocket-client-git-socket-complete.seancowan-dev.now.sh/",
    DATABASE_URL: process.env.DATABASE_URL || "postgresql://dunder_mifflin:password@localhost/fsocket"
  }

  //    ORIGIN_URL: "https://fsocket-client-git-socket-complete.seancowan-dev.now.sh/" - for live
